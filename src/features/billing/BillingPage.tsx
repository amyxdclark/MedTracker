...
export default function BillingPage() {
  ...
  if (!hasPermission('CompanyAdmin')) {
    return (
      <div className="max-w-4xl mx-auto text-center py-12">
        ...
        <p className="text-slate-500">You need CompanyAdmin or higher permissions to access Billing.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <h2 className="text-lg font-semibold text-slate-900 mb-3">Current Plan</h2>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xl font-bold text-blue-700">Professional Plan</p>
            <p className="text-sm text-slate-500 mt-1">Up to 50 users · Unlimited inventory items · Priority support</p>
          </div>
          <Badge variant="ok">Active</Badge>
        </div>
        <div className="mt-4 grid grid-cols-3 gap-4 text-center">
          <div className="bg-slate-50 rounded-lg p-3">
            <p className="text-2xl font-bold text-slate-900">$149</p>
          ...
          <div className="bg-slate-50 rounded-lg p-3">
            <p className="text-2xl font-bold text-slate-900">Jul 1</p>
      ...
      <Card>
        <h2 className="text-lg font-semibold text-slate-900 mb-3">Billing History</h2>
            ...
            <tbody>
              {BILLING_HISTORY.map((row, i) => (
                <tr key={i} className="border-b border-slate-100 last:border-0">
                  ...
                  <td className="py-2 font-medium text-slate-900">{row.amount}</td>
